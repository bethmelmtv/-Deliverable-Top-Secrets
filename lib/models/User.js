...
module.exports = class User {
  ...
  static async insert({ firstName, lastName, email, passwordHash }) {
    ...
    return new User(rows[0]); // this is a new instance of the User class
  }
  ...
  //because this is a private class variable, we need to expose it using the function on line 52
};
